      ...
      <div className={styles.container}>
        ...
        <div className={styles[`swiper-pagination`]}>
          <ul className={styles.pagination}>
            ...
            <button className={styles[`swiper-btn`]} onClick={() => setIsSwiperState(state => !state)}>
              {isSwiperState && <i className="fas fa-pause"></i> }
               {!isSwiperState && <i className="fas fa-play"></i>}
            </button>
