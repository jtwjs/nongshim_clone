...
const Home = () => {
  ...
  const [isSwiperState, setIsSwiperState] = useState(false);
    ...
    <section className={styles.home}>
      <div className={styles.container}>
        ...
        <div className={styles[`swiper-pagination`]}>
          ...
          {
            isSwiperState ? 
            <button className={styles[`swiper-btn`]} onClick={() => setIsSwiperState(false)}>
              <i className="fas fa-pause"></i>
            </button>
             :
            <button className={styles[`swiper-btn`]} onClick={() => setIsSwiperState(true)}>
